...
function useComposedRefs(...refs) {
  return React18.useCallback(composeRefs(...refs), refs);
}
...
function createSlot(ownerName) {
  ...
  const Slot2 = React18.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return /* @__PURE__ */ jsx(SlotClone, { ...slotProps, ref: forwardedRef, children: React18.isValidElement(newElement) ? React18.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Presence = (props) => {
  ...
  const child = typeof children === "function" ? children({ present: presence.isPresent }) : React18.Children.only(children);
  const ref = useComposedRefs(presence.ref, getElementRef2(child));
  const forceMount = typeof children === "function";
  return forceMount || presence.isPresent ? React18.cloneElement(child, { ref }) : null;
};
Presence.displayName = "Presence";
function usePresence(present) {
  const [node, setNode] = React18.useState();
  const stylesRef = React18.useRef(null);
  const prevPresentRef = React18.useRef(present);
  const prevAnimationNameRef = React18.useRef("none");
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        isOpen && /* @__PURE__ */ jsx(TooltipProvider2, { delayDuration: 300, children: /* @__PURE__ */ jsx("div", { className: "absolute inset-0 pointer-events-none", children: !selectedCategory ? /* @__PURE__ */ jsx(
          CategoryRing,
          {
            categories: categories2,
...
function RadialWheel({
  ...
  return /* @__PURE__ */ jsx("div", { className: "absolute inset-0", children: items.map((item, index2) => {
    ...
    return /* @__PURE__ */ jsxs(Tooltip2, { children: [
      ...
      /* @__PURE__ */ jsx(TooltipContent2, { side: "right", sideOffset: 8, children: item.label })
    ] }, item.id);
  }) });
}
...
export { ThemeToggle, discoverTokenFiles, getTheme, getThemeCategories, getThemeFilePath, getThemesForCategory, registerTheme, registerThemeFromFile, scanCategory, useTheme, useThemeToggle };
